              ...
              center center`}}>
                    ...
                    <div className="col-md-3">
                      ...
                      <div className="col-md-9">
                        <div className="user-details">
                          <span className="user-name">Contact: {listing.realtor}</span>
                          <span className="post-date">{listing.postedOn}</span>
                        </div>
                ...
                <div className="bottom-info">
                  ...
                  <span className="location">
                    <i className="fa fa-map-marker" aria-hidden="true"></i> {listing.city}, {listing.province}
                  </span>
                </div>
              </div>
            </div>  
    ...
    return (
      <section id="listings">
        <section className="search-area">
          <input type="text" name="search" placeholder="Type to search..." onChange={this.props.change}/>
        </section>
